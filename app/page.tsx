...
export default function Home() {
    ...
    return (
        <div className="flex flex-col items-center justify-center w-screen h-screen overflow-hidden bg-gradient-to-tl from-black via-zinc-600/20 to-black">
            ...
            {/* <h4 className="z-10 text-lg text-transparent duration-500 bg-white cursor-default text-edge-outline animate-title font-display sm:text-6xl md:text-9xl whitespace-nowrap bg-clip-text ">
            ...
            <div className="my-16 text-center animate-fade-in">
                <h2 className="text-sm text-zinc-100 ">
                    Hi, I am Buddhi Vikasitha, a cloud solutions enthusiast.
                </h2>
            </div>
        </div>
    );
